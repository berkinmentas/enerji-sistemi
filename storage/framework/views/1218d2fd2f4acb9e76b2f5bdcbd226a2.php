...
<head>
    ...
    <title>
        <?php if (! empty(trim($__env->yieldContent('title')))): ?>
            <?php echo $__env->yieldContent('title'); ?> | Özay Enerji Sistemleri
        <?php else: ?>
        ...
        <div class="footer-wrapper py-5">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="footer-logo"><img src="<?php echo e(\Illuminate\Support\Facades\Vite::asset('resources/images/logo.png')); ?>" alt=""></div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ozay-enerji-sistemleri/resources/views/layouts/base.blade.php ENDPATH**/ ?>